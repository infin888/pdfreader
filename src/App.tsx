  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-4 px-4 py-4">
        ...
        <section className="flex h-full min-h-[300px] flex-1 flex-col rounded-lg bg-white shadow">
          <div
            ref={viewportRef}
            className="reader-viewport flex-1 overflow-x-auto overflow-y-hidden rounded-t-lg px-6 py-6 snap-x snap-mandatory"
          >
            <div
              ref={flowRef}
